...
<head>
    ...
    <title>Account activatie delga.be</title>
</head>
...
<div style="padding:20px;background-color:#ffffff;box-sizing:border-box;font-size:16px;">
    ...
    <p style="padding:20px;box-sizing:border-box;font-size:16px;">Hartelijk dank voor uw interesse in Delga onderhoudsproducten.</p>
    <p style="padding:20px;box-sizing:border-box;font-size:16px;">Klik <a href="<?=$activatie_link?>" style="text-decoration:none;color:#c52424;box-sizing:border-box;font-size:16px;">hier</a> om uw account te activeren.</p>

...
<script>
    $(document).ready(function(){
        ...
        function fetchUser() // This function will fetch data from table and display under <div id="result">
        {
            var action = "Load";
            $.ajax({
                url : "testopties_crud.php", //Request send to "action.php page"
        ...
        $(document).on('click', '.delete', function(){
            var optie_id = $(this).attr("id"); //This code will fetch any customer id from attribute id with help of attr() JQuery method
            if(confirm("Are you sure you want to remove this data?")) //Confim Box if OK then
            {
                ...
                $.ajax({
                    url:"testopties_crud.php",    //Request send to "action.php page"
                    method:"POST",     //Using of Post method for send data
                    data:{optie_id:optie_id, action:action}, //Data send to server from ajax method
                    success:function(data)
                    {

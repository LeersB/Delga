...
--
-- Host: localhost
-- Gegenereerd op: 29 jan 2021 om 13:04
-- Serverversie: 10.3.21-MariaDB
-- PHP-versie: 7.2.29
...
CREATE TABLE `orders` (
                          ...
                          `opmerking` varchar(300) DEFAULT NULL,
...
CREATE TABLE `order_details` (
                                 ...
                                 `aantal_levering` int(2) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(66, 5, 'Handcreme glycerodermine', 'handcreme_glycerodermine.jpg', 'Handcrème glycerodermine hydrateert de huid en geeft geen vette sporen.  Dringt heel snel in de huid.<br>Helpt bij het voorkomen van kloven en droge huid.', 'Voorkomt kloven en droge huid', '1 tube 50 ml', '', '16.00', 21),
(67, 1, 'Afwasmiddel citroen ', '', 'Afwasmiddel citroen is een ideale ontvetter voor alle vaatwerk en onderhoud van spiegels.<br>Is zacht voor de handen en heeft een aangename geur', 'Super krachtige ontvetter voor een fijne afwas', 'flacon van 1 liter / bidon van 5 liter', '', '5.00', 21),
...
(69, 12, 'Wolly wasmiddel', '', 'Wolly wasmiddel is een ideaal wasmiddel voor wol, fijne was, handwas en gordijnen.<br>Voorkomt pluisvorming en kan zowel voor hand als machine was gebruikt worden\r\n', 'Voor fijne was, wol, handwas en gordijnen', '1 flacon van 1 liter', '', '14.00', 21),
(70, 1, 'Schuurcreme Piek citroen', 'schuurcreme_piek.jpg', 'Schuurcrème piek citroen is zeer doeltreffend voor horecazaken alsook voor huishoudelijk gebruik, dit omdat het een goede werking heeft bij het reinigen van potten en pannen. Tevens kan deze crème ook gebruikt worden voor het reinigen van uw keukens en inox oppervlakten.<br>De crème heeft een heerlijke citroengeur en kan het beste onverdund gebruikt worden met een vochtige doek of spons. Wanneer het middel zijn werk heeft gedaan wel even afspoelen.', 'Doeltreffende reiniging potten, pannen, keuken en inox oppervlakten', '12 x 500 ml', '', '39.00', 21),
(71, 1, 'Vaatdoek katoen ', 'vaatdoeken.jpg', 'Zeer praktische en handige vaatdoeken.<br>\r\nVervaardigd uit katoen, waardoor ze wasbaar zijn op 60°', 'Zeer handige vaatdoeken die wasbaar zijn op 60°', '10 stuks', '', '22.00', 21),
(72, 5, 'Autowas', '', 'Autowas is zeer geschikt voor het reinigen van auto\'s, trucks, caravans, boten,...<br>Kan gebruikt worden met een hoge drukreiniger.<br>Dankzij de sterke werking van deze cleaner wordt alle statische vuil, teer en vet verwijderd. Laat geen sporten na van hard water.', 'Reiniging voor auto\'s, trucks, carvans, boten...<br>Geschikt voor gebruik met hoge drukreiniger.', '1 bidon van 2 liter', '', '0.00', 21),
(73, 2, 'Zilverglans', '', 'Zilverglans is een product waarmee je allerlei vloeren kan dweilen en/of schuren.<br>Het heeft een aangename geur en doet uw vloer glanzen zonder sporen van voetstappen achter te laten.<br>Zeer geschikt voor moderne vloeren.', 'Reinigingsmiddel voorzien van aangename geur die geschikt is voor allerlei vloeren', '1 bidon van 5 liter', '', '28.00', 21),
(74, 2, 'Vloerzeep groen', '', 'Vloerzeep groen zorgt voor de nodige onderhoud van uw vloeren.  Zorgt tevens voor een zeer aangename geur en een schitterende glans.<br>Geschikt voor alle vloeren.', 'Onderhoudsproduct voor vloeren', '1 bidon van 5 liter', '', '20.00', 21),
(75, 2, 'Industriereiniger', '', 'Industriereiniger is onze krachtige allesreiniger, is sterk geconcentreerd en dient voor het afwassen van allerhande oppervlakten.<br>Verwijdert zonder moeite teer en andere vuile vlekken op vloeren.<br>Zeer goed geschikt voor garages en werkplaatsen.', 'Krachtige allesreiniger voor het afwassen van allerhande oppervlakken', '1 bidon van 10 liter', '', '50.00', 21),
(76, 10, 'badcreme', '', 'Deze badcrème zorgt voor een hele zachte huid, bevat onder meer nertsolie en koko\'s olie.<br>Uitstekend geschikt ook voor kinderen en baby\'s.', 'Verzorgende zeep voor een zachte huid.<br>Ook geschikt voor baby\'s en kinderen', '6 x 1 liter', '', '58.00', 21),
(77, 2, 'Allesreiniger ammonia', '', 'Allesreiniger ammonie is zeer geschikt voor het reinigen van linoleum, tegels, houtwerk, lavabo\'s, badkuipen, toonbanken en alle andere afwasbare oppervlakten. Ook geschikt voor glaswerk, ruiten en spiegels.<br>Voor extra vuile plekken zoals teer, olie en vet mag dit product onverdund gebruikt worden.', 'Zeer goede reiniger voor tegels, lavabo\'s, houtwerk, spiegels,...', '1 bidon van 5 liter', '', '20.00', 21),
(78, 2, 'Ovenreiniger', '', 'Deze reiniger lost probleemloos alle vetten op zoals bijvoorbeeld van ovens, machines, braadspitten.<br>Op koude oppervlakten werktijd ± 8 à 10 minuten laten inwerken, daarna met warm water grondig afspoelen.<br>Op warme oppervlakten 35 à 45 graden laten inwerken gedurende een 3 tal minuten en daarna grondig afspoelen met warm water.', 'Krachtige reiniger voor het probleemloos oplossen van alle vetten zoals bv van ovens, machines, braadspitten', '1 bidon van 5 liter', 'Handschoenen dragen bij gebruik van dit product', '40.00', 21),
(79, 2, 'Ruitenreiniger', '', 'Onze ruitenreiniger is een reuk en smaakloos product, dat speciaal geschikt is voor horecabedrijven.<br>het ontvet, ontgeurt, ontsmet en geeft een mooie glans aan glazen, ruiten en spiegels\r\n', 'Krachtige reiniger, ontvetter, glansgever voor glazen, ruiten en spiegels, ideaal voor horecabedrijven.', '1 bidon van 5 liter', '', '28.00', 21),
(80, 12, 'Ariel Color Professional vloeibaar wasmiddel', 'ariel_color_vloeibaar.jpg', 'Ariel Color Professional vloeibaar wasmiddel heeft een maximale waskracht van de gekleurde was.<br>Uitstekende verwijdering van moelijke vlekken. Geeft uw was optimale bescherming en laat het als nieuw uitzien.<br>1 bidon is goed voor 70 wasbeurten.', 'Maximale waskracht voor gekleurde was, verwijdert doeltreffend moeilijke vlekken<br>1 bidon is goed voor 70 wasbeurten', '2 x 70 scoops', '', '98.00', 21);
...
(16, 'Verpakking', '1 liter', '5.00', 67),
(17, 'Verpakking', '5 liter', '16.00', 67),
(18, 'Kleur', 'blauw', '0.00', 37),
(19, 'Kleur', 'zwart', '0.00', 37),
(20, 'Kleur', 'roze', '0.00', 37),
(21, 'Kleur', 'geel', '0.00', 37),
(22, 'Verpakking', '500 ml', '8.00', 29),
(23, 'Verpakking', '5 liter', '50.00', 29);
...
(23, 'Bart', 'Leers', 'info@leers.pro', '$2y$10$/R2b3niWW8P0tLT8leQ/f.cYmFq0z/JUFdZCxAjo8Y9dVoJDP76Zi', '2020-12-10 11:53:00', 'Holstraat', '29/1', '8790', 'Waregem', 'Voorzienigheidsstraat', '18', '8500', 'Kortrijk', '0494300380', NULL, NULL, 'Admin', 'activated', '', ''),
(24, 'Lydia', 'Delhaye', 'lydia.delhaye@telenet.be', '$2y$10$ZfRI9FWQyRs3VGNJIlCfxezyjgQd2tk0laq/g6kr.J84USKDiKkBu', '2020-12-10 11:54:20', 'Holstraat', '29/1', '8790', 'Waregem', '', '', '', '', '0497433265', '', '', 'Admin', 'activated', NULL, ''),
(26, 'Test', 'Delga', 'test@delga.be', '$2y$10$Okz7P0L.29ZkqiIn3xAUDOLANJY64/dpfRqy9dj6US.IqOiaN/Z4C', '2020-12-11 01:45:06', 'Voorzienigheidsstraat', '18', '8500', 'Kortrijk', '', '', '', '', '0123/123456', '', '', 'Prive', 'activated', NULL, ''),
(30, 'Bart', 'Leers', 'security@leers.pro', '$2y$10$jkB7KLnNOJnyzwEoZuxkY.BlfXmiQ0/fe6rqOXzFWTknnQzha7XLC', '2021-01-05 18:56:00', 'Holstraat', '29/1', '8790', 'Waregem', '', '', '', '', '0494300380', 'Bond', '007007007', 'Bedrijf', 'activated', '', ''),
(31, 'Bart', 'Leers', 'bart_leers@telenet.be', '$2y$10$ljzJnjpjL0Rh7gHZnKt7UeNamwLIPyU1As7T/O1YGQIyiJhS1W5z2', '2021-01-18 09:49:11', 'Holstraat', '29/1', '8790', 'Waregem', 'Voorzienigheidsstraat', '18', '8500', 'Kortrijk', '0494300380', '', '', 'Prive', 'activated', NULL, ''),
(32, 'Bart', 'Leers', 'leers_bart@telenet.be', '$2y$10$PTjYWHCXsSMH88VFVTB81.oTZE1x6L.rLjXNHDNT8R12ZPAt0n8we', '2021-01-18 10:46:14', 'Holstraat', '29/1', '8790', 'Waregem', 'Voorzienigheidsstraat', '18', '8500', 'Kortrijk', '0494300380', '', '', 'Prive', 'activated', NULL, '');
...
--
ALTER TABLE `producten`
    MODIFY `product_id` int(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=81;

--
-- AUTO_INCREMENT voor een tabel `product_opties`
--
ALTER TABLE `product_opties`
    MODIFY `optie_id` int(4) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

    ...
    <div class="container">
        <div class="login-container row">
                        ...
                        <div class="row">
                            <div class="col">
                                <button class="btn btn-success" type="submit" name="submit"><i
                                            class="fas fa-sign-in-alt"></i> Aanmelden
                                </button>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-xs-12 pull-right">
                <h2 class="title" id="block-new-customer-heading" aria-level="2">
                    Eerste keer hier? Welkom!
                </h2>
                <p>Laat alvast je gegevens achter. <br>Met een eigen Delga account bestel je snel en 100%
                    veilig.</p>
                <div class="primary">
                    <a href="registratie-aanvraag.php" class="action create btn btn-secondary">Een Delga account
                        aanmaken</a>
                </div>
            </div>
        </div>
